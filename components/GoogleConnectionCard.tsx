    ...
    <div className="space-y-4 rounded-xl border border-gray-200 bg-white p-5">
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          disabled={isPending}
          className="inline-flex items-center gap-1.5 rounded-md border border-gray-200 px-2.5 py-1.5 text-sm text-gray-600 hover:bg-gray-50 disabled:opacity-50"
        >
            ...
            {status.projects.map((p) => (
              ...
              >
                <div className="min-w-0">
                  ...
                  <div className="flex items-center gap-1 truncate font-mono text-xs text-gray-400">
                ...
                {p.added ? (
                  ...
                  <button
                    ...
                    disabled={isPending}
                    className="inline-flex shrink-0 items-center gap-1 rounded-md border border-gray-200 px-2.5 py-1 text-xs font-medium text-gray-700 hover:bg-gray-50 disabled:opacity-50"
                  >
